...
%prep
%setup -q -n pytest-cov-2.11.1
cd %{_builddir}/pytest-cov-2.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611160741
...
cp %{_builddir}/pytest-cov-2.11.1/LICENSE %{buildroot}/usr/share/package-licenses/pytest-cov/07800edab5f4e77a7371e226f11ba91f963a11cf
