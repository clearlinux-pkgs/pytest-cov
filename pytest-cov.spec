...
%prep
%setup -q -n pytest-cov-2.9.0
cd %{_builddir}/pytest-cov-2.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590373072
...
cp %{_builddir}/pytest-cov-2.9.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-cov/07800edab5f4e77a7371e226f11ba91f963a11cf
